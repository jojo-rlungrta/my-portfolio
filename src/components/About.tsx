export default function About() {
  return (
    <section>
      <h2 className="text-3xl font-semibold tracking-wide">About Me</h2>
      <p className="mt-6">Front-end Developer and Web Project Manager with 8+ years of experience delivering high-quality corporate websites for enterprise clients in Japan.</p>
